...
const handleSubmit = async () => {
  try {
    const response = await axios.post('http://localhost:3000/api/v1/user-register', {
      ...
      // marketing_accept: marketingAccept.value,
    });
  ...
  <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
    ...
    >
      <div class="max-w-xl lg:max-w-3xl">
        ...
        <form @submit.prevent="handleSubmit" class="mt-8 grid grid-cols-6 gap-6">
          ...
          <div class="col-span-6 sm:flex sm:items-center sm:gap-4">
            ...
            <p class="mt-4 text-sm text-gray-500 sm:mt-0">
              ...
              <router-link to="/login" class="text-gray-700 underline">Sign In</router-link>
            </p>
          </div>
        </form>
      </div>
